...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__matrix_element__ = __webpack_require__(30);


var Matrix = (function () {
    function Matrix(array) {
        this.array = array.map(function (x) { return __WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __spread */](x); });
        try {
            for (var _a = __WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __values */](this.array), _b = _a.next(); !_b.done; _b = _a.next()) {
                var rowArray = _b.value;
                if (rowArray.length != this.columns()) {
                    debugger;
                    throw new RangeError("Every row of matrix should have same number of elements");
                }
            }
        }
        ...
        if (this.rows() < 1) {
            throw new RangeError("Matrix should have at least 1 row");
        }
        if (this.columns() < 1) {
            throw new RangeError("Matrix should have at least 1 column");
        }
        var e_1, _c;
    }
    ...
    Matrix.prototype.element = function (row, column) {
        return new __WEBPACK_IMPORTED_MODULE_1__matrix_element__["a" /* MatrixElement */](this.array, row, column);
    };
    return Matrix;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__matrix__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__matrix_grid__ = __webpack_require__(33);
...
var Main = (function (_super) {
    __WEBPACK_IMPORTED_MODULE_0_tslib__["a" /* __extends */](Main, _super);
    function Main(props) {
        var _this = _super.call(this, props) || this;
        var matrix = new __WEBPACK_IMPORTED_MODULE_3__matrix__["a" /* Matrix */]([[2, 1], [3, 4]]);
        var calculating = false;
        _this.state = { matrix: matrix, calculating: calculating };
        _this.onElementChange = _this.onElementChange.bind(_this);
        _this.onSizeInclease = _this.onSizeInclease.bind(_this);
        _this.onSizeDecrease = _this.onSizeDecrease.bind(_this);
        _this.onCalculateDeterminant = _this.onCalculateDeterminant.bind(_this);
        _this.onCalculateDeterminantUsingPermutations = _this.onCalculateDeterminantUsingPermutations.bind(_this);
        return _this;
    }
    Main.prototype.onElementChange = function (row, column, value) {
        var matrix = this.state.matrix;
        matrix.element(row, column).setValue(value);
        this.setState({ matrix: matrix });
    };
    Main.prototype.onSizeInclease = function () {
        var rows = [];
        for (var i = 1; i <= this.state.matrix.rows(); i++) {
            var elements = [];
            for (var j = 1; j <= this.state.matrix.columns(); j++) {
                var element = this.state.matrix.element(i, j);
                elements.push(element.getValue());
            }
            elements.push(0);
            rows.push(elements);
        }
        var lastRow = [];
        for (var i = 1; i <= this.state.matrix.columns(); i++) {
            lastRow.push(0);
        }
        lastRow.push(1);
        rows.push(lastRow);
        var matrix = new __WEBPACK_IMPORTED_MODULE_3__matrix__["a" /* Matrix */](rows);
        this.setState({ matrix: matrix });
    };
    Main.prototype.onSizeDecrease = function () {
        var rows = [];
        for (var i = 1; i < this.state.matrix.rows(); i++) {
            var elements = [];
            for (var j = 1; j < this.state.matrix.columns(); j++) {
    ...
    Main.prototype.onCalculateDeterminant = function () {
        var _this = this;
        this.setState({ calculating: true }, function () {
            setTimeout(function () {
                var determinant = Object(__WEBPACK_IMPORTED_MODULE_3__matrix__["b" /* calculateDeterminant */])(_this.state.matrix);
                _this.setState({ calculating: false }, function () {
                    alert("Determinant calculated using upper triangle form is " + determinant);
                });
            }, 0);
        });
    };
    Main.prototype.onCalculateDeterminantUsingPermutations = function () {
        var _this = this;
        this.setState({ calculating: true }, function () {
            setTimeout(function () {
                var determinant = Object(__WEBPACK_IMPORTED_MODULE_3__matrix__["c" /* calculateDeterminantUsingPermutations */])(_this.state.matrix);
                _this.setState({ calculating: false }, function () {
                    alert("Determinant calculated using permutations is " + determinant);
                });
            }, 0);
        });
    };
    Main.prototype.render = function () {
        if (this.state.calculating) {
            return (__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", null, "Calculating, please wait..."));
        }
        return (__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", null,
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__matrix_grid__["a" /* MatrixGrid */], { matrix: this.state.matrix, onElementChange: this.onElementChange }),
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("button", { onClick: this.onSizeInclease }, "+"),
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("button", { onClick: this.onSizeDecrease, disabled: this.state.matrix.rows() < 2 }, "-"),
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("br", null),
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("button", { onClick: this.onCalculateDeterminant }, "Calculate determinant using upper triangle form"),
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("br", null),
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("button", { onClick: this.onCalculateDeterminantUsingPermutations }, "Calculate determinant using permutations")));
    };
    return Main;
}(__WEBPACK_IMPORTED_MODULE_1_react__["Component"]));
__WEBPACK_IMPORTED_MODULE_2_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(Main, null), document.getElementById("root"));
...
*/
var aa=__webpack_require__(3),m=__webpack_require__(9),A=__webpack_require__(4),B=__webpack_require__(1),ca=__webpack_require__(10),da=__webpack_require__(11),ea=__webpack_require__(12),ha=__webpack_require__(13),ia=__webpack_require__(14),C=__webpack_require__(5);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__matrix__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__matrix_operations__ = __webpack_require__(31);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__matrix_operations__["a"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_1__matrix_operations__["b"]; });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MatrixElement; });
var MatrixElement = (function () {
    function MatrixElement(array, row, column) {
        this.rowArray = array[row - 1];
        if (this.rowArray === void 0) {
            throw new RangeError("Invalid row: " + row);
        }
        this.index = column - 1;
        var element = this.rowArray[this.index];
        if (element === void 0) {
            throw new RangeError("Invalid column: " + column);
        }
    }
    MatrixElement.prototype.getValue = function () {
        return this.rowArray[this.index];
    };
    MatrixElement.prototype.setValue = function (value) {
        this.rowArray[this.index] = value;
    };
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = calculateDeterminant;
/* harmony export (immutable) */ __webpack_exports__["b"] = calculateDeterminantUsingPermutations;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__matrix__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__permutations__ = __webpack_require__(32);
...
function createMatrixCopy(matrix) {
    ...
    for (var i = 1; i <= matrix.rows(); i++) {
        ...
        for (var j = 1; j <= matrix.columns(); j++) {
            var element = matrix.element(i, j).getValue();
            rowArray.push(element);
        }
        matrixArray.push(rowArray);
    }
    return new __WEBPACK_IMPORTED_MODULE_1__matrix__["a" /* Matrix */](matrixArray);
}
function applyRowAddition(matrix, sourceRow, toRow, k) {
    if (sourceRow == toRow) {
        throw new RangeError("Cannot add row " + sourceRow + " to itself");
    }
    for (var i = 1; i <= matrix.columns(); i++) {
        var sourceElement = matrix.element(sourceRow, i);
        var toElement = matrix.element(toRow, i);
        toElement.setValue(toElement.getValue() + k * sourceElement.getValue());
    }
}
function applyColumnAddition(matrix, sourceColumn, toColumn, k) {
    if (sourceColumn == toColumn) {
        throw new RangeError("Cannot add column " + sourceColumn + " to itself");
    }
    for (var i = 1; i <= matrix.rows(); i++) {
        var sourceElement = matrix.element(i, sourceColumn);
        var toElement = matrix.element(i, toColumn);
        toElement.setValue(toElement.getValue() + k * sourceElement.getValue());
    }
}
function makeDiagElementNonZero(matrix, index) {
    for (var i = index + 1; i <= matrix.rows(); i++) {
        var element = matrix.element(i, index);
        if (element.getValue() != 0) {
            applyRowAddition(matrix, i, index, 1);
            return true;
        }
    }
    for (var i = index + 2; i <= matrix.rows(); i++) {
        for (var j = index + 1; j < i; j++) {
            var element = matrix.element(i, j);
            if (element.getValue() != 0) {
                applyColumnAddition(matrix, j, index, 1);
                applyRowAddition(matrix, i, index, 1);
                return true;
            }
        }
...
function transformToUpperTriangle(matrix) {
    if (matrix.rows() != matrix.columns()) {
        throw new TypeError("Matrix should be squared");
    }
    for (var i = 1; i <= matrix.rows(); i++) {
        var diagElement = matrix.element(i, i);
        if (diagElement.getValue() == 0) {
            var elementMadeNonZero = makeDiagElementNonZero(matrix, i);
            if (!elementMadeNonZero) {
                return;
            }
        }
        for (var j = i + 1; j <= matrix.columns(); j++) {
            var elementUnderDiag = matrix.element(j, i);
            var k = -elementUnderDiag.getValue() / diagElement.getValue();
            applyRowAddition(matrix, i, j, k);
        }
    }
}
function calculateDeterminant(matrix) {
    var upperTriangle = createMatrixCopy(matrix);
    transformToUpperTriangle(upperTriangle);
    var result = 1;
    for (var i = 1; i <= upperTriangle.rows(); i++) {
        result *= upperTriangle.element(i, i).getValue();
    }
    return result;
}
function calculateDeterminantUsingPermutations(matrix) {
    if (matrix.rows() != matrix.columns()) {
        throw new TypeError("Matrix should be squared");
    }
    var sum = 0;
    try {
        for (var _a = __WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __values */](Object(__WEBPACK_IMPORTED_MODULE_2__permutations__["a" /* enumeratePermutations */])(matrix.rows())), _b = _a.next(); !_b.done; _b = _a.next()) {
            var _c = _b.value, inversions = _c.inversions, permutarion = _c.permutarion;
            var product = (inversions % 2 == 0) ? 1 : -1;
            for (var i = 0; i < matrix.rows(); i++) {
                var element = matrix.element(i + 1, permutarion[i]);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = enumeratePermutations;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(2);

function enumerateAdjacentTranspositions(n) {
    var C, PR, i_1, i, x, k;
...
function enumeratePermutations(n) {
    var permutarion, i, inversions, _a, _b, transposition, left, right, e_1_1, e_1, _c;
    return __WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __generator */](this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                inversions = 0;
                return [4, { inversions: inversions, permutarion: __WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __spread */](permutarion) }];
            case 1:
                _d.sent();
                _d.label = 2;
            case 2:
                _d.trys.push([2, 7, 8, 9]);
                _a = __WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __values */](enumerateAdjacentTranspositions(n)), _b = _a.next();
                _d.label = 3;
            case 3:
                if (!!_b.done) return [3, 6];
                transposition = _b.value;
                left = permutarion[transposition - 1];
                right = permutarion[transposition];
                permutarion[transposition - 1] = right;
                permutarion[transposition] = left;
                inversions += (left < right) ? 1 : -1;
                return [4, { inversions: inversions, permutarion: __WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __spread */](permutarion) }];
            case 4:
                _d.sent();
                _d.label = 5;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MatrixGrid; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react__);
...
var MatrixGrid = (function (_super) {
    __WEBPACK_IMPORTED_MODULE_0_tslib__["a" /* __extends */](MatrixGrid, _super);
    function MatrixGrid(props) {
        var _this = _super.call(this, props) || this;
        _this.onCellChange = _this.onCellChange.bind(_this);
        return _this;
    }
    MatrixGrid.prototype.onCellChange = function (event) {
        var _a = __WEBPACK_IMPORTED_MODULE_0_tslib__["c" /* __read */](event.target.name.split('-'), 2), row = _a[0], column = _a[1];
        var value = +event.target.value;
        this.props.onElementChange(+row, +column, value);
    };
    MatrixGrid.prototype.render = function () {
        var rows = [];
        for (var i = 1; i <= this.props.matrix.rows(); i++) {
            var cells = [];
            for (var j = 1; j <= this.props.matrix.columns(); j++) {
                var element = this.props.matrix.element(i, j);
                cells.push(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("td", { key: j },
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("input", { style: cellStyle, value: element.getValue(), name: i + "-" + j, onChange: this.onCellChange })));
            }
            rows.push(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("tr", { key: i }, cells));
        }
        return (__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("table", null,
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("tbody", null, rows)));
    };
    return MatrixGrid;
}(__WEBPACK_IMPORTED_MODULE_1_react__["Component"]));
